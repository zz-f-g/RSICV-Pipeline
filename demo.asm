...
int main() {
   ...
   10068:	1fc7a483          	lw	s1,508(a5) # 101fc # 0x1fc = 508
   1006c:	1fc78713          	addi	a4,a5,508 #
   10070:	00472383          	lw	t2,4(a4) # 0000 000_0 0100 _0111 0_010_0011 1_000 0011 
   10074:	1fc78713          	addi	a4,a5,508 #
   10078:	00872283          	lw	t0,8(a4)
   1007c:	1fc78713          	addi	a4,a5,508 #
   10080:	00c72303          	lw	t1,12(a4)
   10084:	1fc78713          	addi	a4,a5,508 #
   10088:	01072503          	lw	a0,16(a4)
   1008c:	1fc78713          	addi	a4,a5,508 #
   10090:	01472583          	lw	a1,20(a4)
   10094:	1fc78713          	addi	a4,a5,508 #
   10098:	01872603          	lw	a2,24(a4)
   1009c:	1fc78713          	addi	a4,a5,508 #
   100a0:	01c72683          	lw	a3,28(a4)
   100a4:	1fc78713          	addi	a4,a5,508 #
   100a8:	02072703          	lw	a4,32(a4)
   100ac:	1fc78793          	addi	a5,a5,508 #
   ...
   101ac:	00800793          	li	a5,8 # 0000000_01000_00000_000_01111_0010011
   ...
   101ec:	03812403          	lw	s0,56(sp)
   101f0:	03412483          	lw	s1,52(sp)
   101f4:	03c10113          	addi	sp,sp,60
   101f8:	00008067          	ret
